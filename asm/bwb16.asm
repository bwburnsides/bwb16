...
#fn im4(func, r, im)      => le(func     @ r`4       @ im[3:3] @ im[2:0]   @ 0b1000                                 )
#fn im6(func, r, im)      => le(func     @ im[4:3]   @ r`4     @ im[5:5]   @ im[2:0]  @ 0b1000                                 )
...
#ruledef cpu16 {
    ...
    addi {rd: reg} {im: i6} => im6(0b00, rd, im)
    cmpi {rd: reg} {im: i6} => im6(0b01, rd, im)
    jal {rs: reg} {im: i6}  => im6(0b10, rs, im)

    shli {rd: reg} {im: i4} => im4(0b1100, rd, im)
    lsri {rd: reg} {im: i4} => im4(0b1101, rd, im)
    asri {rd: reg} {im: i4} => im4(0b1110, rd, im)
    andi {rd: reg} {im: i4} => im4(0b1111, rd, im)
